...
import {faMapMarkerAlt, faMoneyBillWave, faPersonBooth, faUserAlt} from '@fortawesome/free-solid-svg-icons';
import {If} from './Lib';
                ...
                <div className="searchRowLocation">
                    ...
                    <If if={props.city}><Typography color="primary"><FontAwesomeIcon
                        style={{marginLeft: "5px",position: "relative",
                            top: "2px"}}
                        icon={faUserAlt} className="faIcon"/></Typography><span style={{position: "relative",
                        top: "5px"
                    }}>{props.city}</span>
                    </If>
